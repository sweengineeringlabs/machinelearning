...
use super::add_backward::AddBackward;
use super::sub_backward::SubBackward;
...
mod tests {
    ...
    /// @covers: backcast_size
    #[test]
    fn test_backcast_size_returns_input_window() {
        let model = NBeats::new(12, 4, 3, 2, 32, 3);
        assert_eq!(model.backcast_size(), 12);
    }

    /// @covers: forecast_size
    #[test]
    fn test_forecast_size_returns_horizon() {
        let model = NBeats::new(12, 4, 3, 2, 32, 3);
