...
fn test_matmul_gradient() {
    ...
    tape::record_op(TapeEntry {
        backward_op: Box::new(ml_sdk::core::ops::matmul::MatMulBackward),
        output_id: output.id(),
...
fn test_add_gradient() {
    ...
    tape::record_op(TapeEntry {
        backward_op: Box::new(ml_sdk::core::ops::add::AddBackward {
...
fn test_mul_gradient() {
    ...
    tape::record_op(TapeEntry {
        backward_op: Box::new(ml_sdk::core::ops::mul::MulBackward),
        output_id: output.id(),
        input_ids: vec![a.id(), b.id()],
        saved_tensors: vec![a.clone(), b.clone()],
    });
...
fn test_relu_gradient() {
    ...
    use rustml_swets::api::tape::{TapeEntry, BackwardOp};
    use ml_sdk::core::ops::relu::ReLUBackward;
