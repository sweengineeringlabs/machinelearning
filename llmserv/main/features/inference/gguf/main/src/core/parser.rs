...
impl GGUFFile {
    ...
    pub fn load_tensors<P: AsRef<Path>>(
        ...
        for info in &self.tensor_infos {
            ...
            let loaded = if info.ggml_type.needs_dequant() {
                ...
                let f32_bytes = swe_llmmodel_kernel::f32_vec_to_bytes(f32_data);
                LoadedTensor {
                    data: f32_bytes,
                    shape,
    ...
    pub fn read_tensor_f32<P: AsRef<Path>>(
        ...
        match info.ggml_type {
            ...
            GGMLType::Q4_0 => swe_llmmodel_kernel::dequantize_q4_0(&raw, n_elements)
                .map_err(|e| GgufError::UnsupportedType(e.to_string())),
            GGMLType::Q8_0 => swe_llmmodel_kernel::dequantize_q8_0(&raw, n_elements)
                .map_err(|e| GgufError::UnsupportedType(e.to_string())),
            GGMLType::Q4_1 => swe_llmmodel_kernel::dequantize_q4_1(&raw, n_elements)
                .map_err(|e| GgufError::UnsupportedType(e.to_string())),
            GGMLType::Q5_0 | GGMLType::Q5_1 | GGMLType::Q8_1 => {
